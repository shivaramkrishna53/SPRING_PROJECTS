...
public class Daoproj12BootProfilesUsingpropertiesfileApplication {

	public static void main(String[] args) throws Exception {
		ApplicationContext ctx=SpringApplication.run(Daoproj12BootProfilesUsingpropertiesfileApplication.class, args);
