...
public class daoproj13bootprofilesusingymlfileApplication {

	public static void main(String[] args) throws Exception {
		ApplicationContext ctx=SpringApplication.run(daoproj13bootprofilesusingymlfileApplication.class, args);
