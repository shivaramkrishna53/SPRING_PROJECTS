...
//		reader.loadBeanDefinitions("com/calculateintrest/cfgs/ApplicationContext.xml");
		...
		ClassPathXmlApplicationContext ctx=new ClassPathXmlApplicationContext("com/calculateintrest/cfgs/applicationContext.xml");
		CustomerController contro=ctx.getBean("customercontroller",CustomerController.class);
		try
		{
