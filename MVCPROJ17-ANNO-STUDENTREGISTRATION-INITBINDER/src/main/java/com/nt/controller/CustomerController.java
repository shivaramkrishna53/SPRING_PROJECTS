...
public class CustomerController {
	...
	public String CustomerFormValidation(Map<String,Object> m, @ModelAttribute("cust")Customer c,Errors e,RedirectAttributes redirectatt)
	{
		...
		System.out.println("Gender::"+c.getGender()+" Hoobies:: "+Arrays.deepToString(c.getHobbies())+" Skills:: "+c.getSkills()+ " Countries Visited::"+c.getCountriesvisited()+" Languages Known::"+ c.getLanguagesknown()+"DOB::"+c.getDob()+"DOJ::"+c.getDoj());
	...
	@InitBinder
	public void myinitBinder(ServletRequestDataBinder srdb)
	{
